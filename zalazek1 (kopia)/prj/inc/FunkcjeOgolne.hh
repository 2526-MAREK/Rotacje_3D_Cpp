...
void WywolanieObrotuWedlugOdpowiednichOznaczen(Macierz3x3 &MacRot, Prostopadloscian &Pr, Scena *Sc,int *wskIloscStruktur,std::string &OznaczeniaOsiObrotu,double* KatObrotu, int IndeksDanej);
