...
int main()
{
 ...
 // Scena * wsk_Scena = NULL;//new Scena[*wskIloscStruktur];
  ...
  WczytajDaneDoObrotuProstopadloscianu(MacRot, Pr, Sc);
  ...
  //std::cout<<" Ilosc powtorzen: "<< Sc[0].IloscPowtorzen<<std::endl;
...
void UruchomObrotProstopadloscianuIZapamietajMacRot(Macierz3x3 &MacRot, Macierz3x3 &MacRotTym, Prostopadloscian &Pr, Scena *Sc, int i, int * wskIloscStruktur, int i2)
{
  ...
  std::cout<<Sc[i].MacierzRotacji<<std::endl;
}
...
int WczytajDaneDoObrotuProstopadloscianu(Macierz3x3 &MacRot, Prostopadloscian &Pr, Scena *Sc, int *wskIloscStruktur)
{
    ...
    while((std::cin>>OznaczenieOsiObrotu)&&(OznaczenieOsiObrotu != '.')){
        switch(OznaczenieOsiObrotu)
        {
            case 'x':
            {
              WczytanieKataObrotuIOznaczeniaOsi(OznaczeniaOsiObrotu,KatObrotu, wsk_IndeksDanej, 'x');
              break;
            }
            case 'y':
            {
              WczytanieKataObrotuIOznaczeniaOsi(OznaczeniaOsiObrotu,KatObrotu, wsk_IndeksDanej, 'y');
              break;
            }
            case 'z':
            {
              WczytanieKataObrotuIOznaczeniaOsi(OznaczeniaOsiObrotu,KatObrotu, wsk_IndeksDanej, 'z');
              break;
            }
            default:
            {
    ...
    /*for(int i =0; i<=IndeksDanej;++i)
      std::cout<<OznaczeniaOsiObrotu[i] << KatObrotu[i]<< std::endl;*/
    ...
    while(i<=IndeksDanej)
    {
      ...
      switch(OznaczeniaOsiObrotu[i])
      {
        case 'x':
        {
          ...
          {
            if((OznaczeniaOsiObrotu[++i])=='x'){
              MacRotTym = MacRot;
              UruchomObrotProstopadloscianuIZapamietajMacRot(MacRot,MacRotTym,Pr,Sc, i, wskIloscStruktur, i2);
              std::cout<<"Uruchomiono dwuargumntowy obrotProstopadloscianuXX"<<std::endl;
              break;
            }
            else //jeśli następna zapisana dana nie jest x to zmniejsz licznik
              --i;
            if((OznaczeniaOsiObrotu[++i])=='y'){
              MacRotTym = {cos(ALFA), 0, sin(ALFA), 0, 1, 0, -sin(ALFA), 0, cos(ALFA)};
              UruchomObrotProstopadloscianuIZapamietajMacRot(MacRot,MacRotTym,Pr,Sc, i, wskIloscStruktur, i2);
              std::cout<<"Uruchomiono dwuargumntowy obrotProstopadloscianuXY"<<std::endl;
              break;
            }
            else //jeśli następna zapisana dana nie jest y to zmniejsz licznik
              --i;
            if((OznaczeniaOsiObrotu[++i])=='z'){
              MacRotTym = {cos(ALFA), -sin(ALFA),0, sin(ALFA), cos(ALFA), 0, 0, 0,1};
              UruchomObrotProstopadloscianuIZapamietajMacRot(MacRot,MacRotTym,Pr,Sc, i, wskIloscStruktur, i2);
              std::cout<<"Uruchomiono dwuargumntowy obrotProstopadloscianuXZ"<<std::endl;
              break;
            }
         }
         else{
        ...
        case 'y':
        {
          ...
          if((IndeksDanej>0)&&!(i==IndeksDanej))
          {
            if((OznaczeniaOsiObrotu[++i])=='y'){
              MacRotTym = MacRot;
              UruchomObrotProstopadloscianuIZapamietajMacRot(MacRot,MacRotTym,Pr,Sc, i,wskIloscStruktur, i2);
              std::cout<<"Uruchomiono dwuargumntowy obrotProstopadloscianuYY"<<std::endl;
              break;
            }
            else //jeśli następna zapisana dana nie jest x to zmniejsz licznik
              --i;
            if((OznaczeniaOsiObrotu[++i])=='x'){
              ...
              UruchomObrotProstopadloscianuIZapamietajMacRot(MacRot,MacRotTym,Pr,Sc, i,wskIloscStruktur, i2);
              std::cout<<"Uruchomiono dwuargumntowy obrotProstopadloscianuYX"<<std::endl;
              break;
            }
            else //jeśli następna zapisana dana nie jest y to zmniejsz licznik
              --i;
            if((OznaczeniaOsiObrotu[++i])=='z'){
              MacRotTym = {cos(ALFA), -sin(ALFA),0, sin(ALFA), cos(ALFA), 0, 0, 0,1};
              UruchomObrotProstopadloscianuIZapamietajMacRot(MacRot,MacRotTym,Pr,Sc, i,wskIloscStruktur, i2);
              std::cout<<"Uruchomiono dwuargumntowy obrotProstopadloscianuYZ"<<std::endl;
              break;
            }
         }
         else{
        ...
        case 'z':
        {
          ...
          Pr.ObrotProstopadloscianu(MacRot);
          std::cout<<"Uruchomiono jednoargumentowy obrotProstopadloscianuZ"<<std::endl;
          break;
         }
        }
      }
